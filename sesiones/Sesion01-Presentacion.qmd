...
format:
  beamer:
    ...
    include-in-header:
      - preambulo_comun.tex
      - text: |
          \newcommand{\SesionTitulo}{Sesión 01 \\ Introducción a la idea fundamental del Cálculo Diferencial}
  html: default
  docx: default
---
...
![](./portadasSesiones/01-frailecilloNoruega.jpg){height="60%" fig-align="center"}
