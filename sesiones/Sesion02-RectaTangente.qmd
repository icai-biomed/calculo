...
$$
\underbrace{\,\,f(x)\,\,}_{\text{valor función}} \approx \underbrace{f(x_0) + m (x - x_0)}_{\text{valor recta}}
$$
...
¿Por qué? En el notebook, trata de calcular `apprx_slope(x0=x0, x = x0)`. ¿Cuál es la respuesta?
...
+ Usa la construcción de GeoGebra para explorar con zoom lo que ocurre en el origen. De momento basta con eso, volveremos sobre este problema en la próxima sesión.
$$f(x) = \dfrac{x}{1 + e^{1/ x}}$$
