...
![](./portadasSesiones/04-CarracaOkavango.jpg){width="80%"}
...
# Límites en infinito. Asíntotas horizontales y oblicuas.
...
$\displaystyle\lim_{x \to 0} \sin(x) \,\left(\dfrac{(\log(x))^2}{x^2 + (\log(x))^2}\right) = 0$   
