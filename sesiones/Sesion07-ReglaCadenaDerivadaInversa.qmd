...
Hay otra inversa local definida mediante $-\sqrt{\phantom{2}}$ que funciona a la izquierda, para $x < 0$. Pero es importante entender que **no hay una inversa global que funcione para todos los valores de $x$**.
