...
\textbf{\textcolor{firebrick}{Ejercicio 06B02.}} Busca una fórmula para $(f(x)g(x)h(x))'$. ¿Y si son 10 funciones? 
...
La derivada del cociente se obtiene de forma similar, pero el análisis del error es técnicamente más complicado. En la próxima sesión veremos otras reglas de derivación. 
