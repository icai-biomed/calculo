...
+ Calcula valores aproximados de $\sqrt{1.03}$ y de $\log(1.003)$, pero en este cao usa las fórmulas para las derivadas que ya conoces.\footnote{Salvo que se diga lo contrario, todos los logaritmos son neperianos y todos los ángulos se expresan en radianes.}\newline
